...
if not exist "input_materials" mkdir input_materials
if not exist "output_sites" mkdir output_sites
...
:error
echo.
echo Generation failed. Check the error message above.
pause
exit /b 1
...
echo Please close this window, delete the .venv folder, and run run_app.bat again.
pause
exit /b 1
